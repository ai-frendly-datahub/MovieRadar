#!/usr/bin/env python3
"""Run DuckDB data quality checks and refresh MovieRadar quality JSON."""
...
from movieradar.common.quality_checks import run_all_checks  # noqa: E402
from movieradar.config_loader import (  # noqa: E402
    load_category_config,
    load_category_quality_config,
)
from movieradar.quality_report import build_quality_report, write_quality_report  # noqa: E402
from movieradar.relevance import (  # noqa: E402
    apply_source_context_entities,
    filter_relevant_articles,
)
from movieradar.storage import RadarStorage  # noqa: E402
...
def generate_quality_artifacts(
    ...
    *,
    ...
    classified_articles = apply_source_context_entities(recent_articles, category_cfg.sources)
...
def main() -> None:
    ...
    print(f"movie_signal_event_count={summary['movie_signal_event_count']}")
