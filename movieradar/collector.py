...
def collect_sources(
    ...
    *,
    ...
    """Fetch items from all configured sources using a 2-pass hybrid pattern.

    Pass 1: RSS/feed sources collected in parallel via ThreadPoolExecutor.
    ...
    if js_sources:
        try:
            ...
            errors.append(
                f"Playwright unavailable for {len(js_sources)} JS source(s). "
